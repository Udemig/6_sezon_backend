...
//! Index
// Verilerin belirli bir alana göre sıralanmış kopyasını oluşturur
// Avantaj: Hangi alana göre sıraldıysam o alana göre yapılan filtreleme/sıralama performası artar.
// Dezavantaj: Oluşturulan her index yer kapladığınınzdan dolayı extra maaliyet / yazma işlemlerinde yavaşlık
tourSchema.index({ price: 1, ratingsAverage: -1 });

// coğrafi bir hesaplama yapıcağımız için ($geoNear) 2dSpehere indexini oluşturmak durumundayız
