  ...
  async UpdateCart(customerId, product, qty, isRemove) {
    try {
      ...
      if (cart) {
        ...
        console.log("DOĞRU PRODUCT", product);
      ...
      console.log("HATA444", error);
      throw new APIError("API Error", 500, "Unable to Update Cart");
    }
  }
}
